...
export default function ProfileSelection({
  ...
  onDeleteProfile,
  onParentLogin,
  onSettings, // settings button
  onBookmarkProfile,
  accessibilityOptions,
}: ProfileSelectionProps) {
  const [selectedProfile, setSelectedProfile] = useState<string | null>(null);
  const [deleteDialogOpen, setDeleteDialogOpen] = useState(false);
  const [profileToDelete, setProfileToDelete] = useState<ChildProfile | null>(
    null
  );
  ...
  const handleChildSelect = (child: ChildProfile) => {
    ...
    speakText(
      `Selected ${child.name}. ${child.scenariosCompleted} scenarios completed.`
    );
      ...
      return [
        {
          ...
          content:
            "EmoStory helps children learn emotional intelligence through interactive scenarios.",
        },
        {
          title: "Creating Child Profiles",
          content:
            "Click 'Add New Child' to create a profile. Each child gets their own avatar and progress tracking.",
        },
        {
          title: "Monitoring Progress",
          content:
            "View your child's emotional learning progress, scenario completion, and positive choice percentage.",
        },
        {
          title: "Accessing Settings",
          content:
            "Click the settings icon (⚙️) to customize accessibility options, audio settings, and privacy controls.",
        },
        {
          title: "Parent Dashboard",
          content:
            "Use 'Parent/Therapist Login' to access detailed analytics and advanced settings.",
        },
      ];
      ...
      return [
        {
          ...
          content:
            "Let's learn about emotions together through fun stories and games!",
        },
        {
          title: "Choose Your Character",
          content:
            "Click on your profile picture to start playing. Each character is special and unique!",
        },
        {
          title: "Playing Scenarios",
          content:
            "You'll see different situations and choose what to do. Think about how others might feel!",
        },
        {
          title: "Making Good Choices",
          content:
            "Try to make choices that help others feel happy. You'll earn stars for being kind!",
        },
        {
          title: "Ask for Help",
          content:
            "If you need help, ask a grown-up! They can help you understand the stories better.",
        },
      ];
    }
    return [];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 relative">
      ...
      <div className="relative z-10">
        ...
        <div className="flex justify-between items-center p4 sm:p-6">
          ...
          <div className="w-full max-w-4xl">
            ...
            <div className="text-center mb-8 sm:mb-12">
              ...
              <p
                ...
                onClick={() =>
                  speakText("Choose your profile to start playing EmoStory!")
                }
              >
                ...
                >
                  ...
                  <CardContent className="p-4 sm:p-8 text-center">
                    ...
                    <p className="text-gray-600 mb-4">
                      {child.scenariosCompleted} scenarios completed
                    </p>
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between text-sm">
                        ...
                        <span>
                          {Math.round(
                            (child.scenariosCompleted / child.totalScenarios) *
                              100
                          )}
                          %
                        </span>
                      ...
                      <div className="w-full bg-gray-200 rounded-full h-2">
                        <div
                          ...
                          style={{
                            width: `${
                              (child.scenariosCompleted /
                                child.totalScenarios) *
                              100
                            }%`,
                          }}
                        />
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              This will permanently remove all their progress and data. This
